...
<body>
    ...
    <?php
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/l5aZJBLAu1E?si=Nb9PxfrBlnCN57LB" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            ';
        } else {
            ...
            <div class="box2">
            <h2> I am REALLY happy, because I have $'.number_format($dollars,2).' American dollars!</h2>
            <iframe width="560" height="315" src="https://www.youtube.com/embed/SoCVbt8d_Ho?si=lMAehunF-pO3f_EF" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
            ';
